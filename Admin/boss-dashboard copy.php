                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card text-center">
                            <div class="card-body">
                                <h4 data-key="dashboard.totalRevenue">Total Revenue</h4>
                                <h3>BIF<?php echo number_format($totalRevenue, 2); ?></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card text-center">
                            <div class="card-body">
                                <h4 data-key="dashboard.totalExpenses">Total Expenses</h4>
                                <h3>BIF<?php echo number_format($totalExpenses, 2); ?></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card text-center">
                            <div class="card-body">
                                <h4 data-key="dashboard.netProfit">Net Profit</h4>
                                <h3>BIF<?php echo number_format($netProfit, 2); ?></h3>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
